...
appControllers.controller('productController', ['$scope', '$routeParams', '$location', '$sce', 'ProductsService',
    function productController($scope, $routeParams, $location, $sce, ProductsService) {
...
appControllers.controller('productEditController', ['$scope', '$routeParams', '$location', '$sce', 'ProductsService',
    function productEditController($scope, $routeParams, $location, $sce, ProductsService) {
        $scope.product = {};
        var id = $routeParams.id;
        $scope.regions = regions;
        $scope.categories = categories;
